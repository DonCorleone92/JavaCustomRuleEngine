...
public class Rule5Test {
	...
	public void positiveTest1() {
		Payment testPayment = new Payment(Boolean.FALSE, PhysicalProductType.NA, NonPhysicalProductType.Membership);
	...
	public void negativeTestProductTypeIsFalse1() {
		Payment testPayment = new Payment(Boolean.TRUE, PhysicalProductType.NA, NonPhysicalProductType.Membership);
		ruleEngine.checkMyRule(testPayment);
	}
	...
	public void negativeTestPhysicalProductTypeIsFalse1() {
		Payment testPayment = new Payment(Boolean.FALSE, PhysicalProductType.Book, NonPhysicalProductType.Membership);
		ruleEngine.checkMyRule(testPayment);
	}

	@Test(expected = RuntimeException.class)
	public void negativeTestPhysicalProductTypeIsFalse2() {
		Payment testPayment = new Payment(Boolean.FALSE, PhysicalProductType.Book,
				NonPhysicalProductType.UpgradeMembership);
		ruleEngine.checkMyRule(testPayment);
	}
